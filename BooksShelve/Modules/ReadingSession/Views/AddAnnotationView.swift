...
struct AddAnnotationView: View {
    ...
    var body: some View {
        let saveValidation = AnnotationValidation.Save.validate(page: page, text: text, book: viewModel.book)
        NavigationStack {
            List {
                Section("Page") {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .topBarTrailing) {
                    Button {
                        guard saveValidation.validated else {
        ...
        .alert(Text("Warning"), isPresented: $showValidationAlert) {
            ...
            Text(saveValidation.message.localized)
        }
    }
    ...
    private func saveAnnotation() {
        ...
        viewModel.annotationDataCoreData.saveToStorage(annotation)
    }
}
